    ...
    <div class="bg-[#81D4FA] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden relative">
                ...
                <!-- Responsive Navigation Menu (Appears Above) -->
                <div x-show="open" @click.away="open = false" class="absolute bottom-14 left-0 w-48 bg-white shadow-lg rounded-md border border-gray-200 z-50">
